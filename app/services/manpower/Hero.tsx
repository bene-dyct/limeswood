      ...
      <div ref={ref}>
        <motion.div style={{ y }} className="absolute inset-0">
          <video
            ...
            playsInline
            preload="auto"
            poster="/manpowerfallback.jpg"
            className="w-full h-full object-cover"
          >
            <source src="https://ik.imagekit.io/myownImagekit/limeswood/manpower.webm" type="video/webm" />
            <source src="https://ik.imagekit.io/sinamage/limeswood/manpower.mp4" type="video/mp4" />
          </video>
        </motion.div>
        ...
        <div className="relative h-screen w-full z-10 px-[6vw] bg-black/30  text-white">
          ...
          <div className="max-w-3xl py-24 md:py-28">
            ...
            <p className="font-body text-base text-[#f0f4f8]/80 leading-relaxed max-w-xl mb-9 animate-fade-up delay-400">
              We provide skilled technical personnel, workforce management, and professional development programs that strengthen engineering operations and support large-scale industrial projects.
            </p>
