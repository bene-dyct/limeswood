import type { Automation } from "../../components/servicesData";
...
export function ServiceCard({ automation }: { automation: Automation }) {
  if (automation.wide) {
    return (
      <div className="service-card-border group col-span-1 md:col-span-2 lg:col-span-3 relative bg-[#f0f4f8] p-10 lg:p-12 grid grid-cols-1 lg:grid-cols-3 gap-10 transition-colors duration-300 hover:bg-[#e4edf3] overflow-hidden">
        ...
        <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4 content-start">
          {automation.wideFeatures?.map((f, i) => (
            <div
              key={i}
            ...
            >
              ...
              <span className="font-body text-sm md:text-[13.5px] text-[#3f5a66]">
                {f.desc}
              </span>
            </div>
          ))}
