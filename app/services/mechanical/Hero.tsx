      ...
      <div ref={ref}>
        <motion.div style={{ y }} className="absolute inset-0">
          <video
            ...
            playsInline
            preload="metadata"
            poster="/mechanicalfallback.jpg"
            className="w-full h-full object-cover"
          >
            <source src="https://ik.imagekit.io/myownImagekit/limeswood/mechanical.webm" type="video/webm" />
            <source src="https://ik.imagekit.io/sinamage/limeswood/mechanical.mp4" type="video/mp4" />
          </video>
        </motion.div>
        ...
        <div className="relative h-screen w-full z-10 px-[6vw] bg-black/30  text-white">
          ...
          <div className="max-w-3xl py-24 md:py-28">
            <div className="flex items-center gap-2.5 font-display text-[10px] md:text-[12px] tracking-[0.25em] uppercase mb-6 animate-fade-up delay-100">
              ...
              Mechanical systems & industrial infrastructure 
            </div>
            ...
            <p className="font-body text-base text-[#f0f4f8]/80 leading-relaxed max-w-xl mb-9 animate-fade-up delay-400">
              We deliver robust mechanical engineering solutions that support efficient operations, equipment reliability, and industrial productivity across complex facilities and processing environments.
            </p>
