      ...
      <div className="absolute inset-0 z-20 flex items-center justify-center text-white pointer-events-none">
        <div className="text-center px-6">
          ...
          <p className="mt-4 text-base md:text-lg">
            Through technical expertise, strategic planning, and attention to detail, we develop tailored approaches that ensure efficiency, safety, and lasting value for our clients.
          </p>
        </div>
      </div>
    </section>
